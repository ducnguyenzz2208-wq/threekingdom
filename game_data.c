...
Card cardDb[TOTAL_CARDS] = {
    ...
    {2,
     ...
     "The Martial Saint wielding the Green Dragon Crescent Blade, perfectly loyal.",
     {0}},
    {3,
     "Trieu Van",
     "Zhao Yun",
    ...
    {6,
     ...
     "Mr. Sleeping Dragon, possessing unmatched strategy. Launched six campaigns from Qishan.",
     {0}},
    ...
    {4,
     ...
     "Fierce general who roared at Changban Bridge, stopping a massive army alone.",
     {0}},
    {5,
     "Dieu Thuyen",
     "Diaochan",
     ...
     "One of the Four Beauties, used a chain stratagem to divide Dong Zhuo and Lu Bu.",
     {0}},
    {8,
     "Ma Sieu",
     "Ma Chao",
     ...
     "Ma Chao the Splendid, terror of Xiliang, forced Cao Cao to cut his beard to escape.",
     {0}},
    {9,
     "Hoang Trung",
     "Huang Zhong",
    ...
    {16,
     ...
     "Patient strategist with the ambition of a wolf, laid the foundation for the Jin Dynasty.",
     {0}},
    {17,
     "Tao Thao",
     "Cao Cao",
